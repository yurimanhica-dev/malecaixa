  ...
  return (
    <Link href="#simulacao" className="flex">
      <button
        ...
        className="group relative inline-flex items-center cursor-pointer outline-none border-0 bg-transparent p-0 text-inherit font-inherit w-[220px] h-12 overflow-hidden rounded-full"
      >
